...
from gui.result_fetcher import fetch_test_results_by_release
...
# Header
header = tk.Label(root, text="\u2699  Test Management", font=("Segoe UI", 20, "bold"), bg="#f0f4f8", fg="#34495e")
header.pack(pady=20)

# Release Selection Frame
...
# Generate Button
generate_btn = tk.Button(root, text="\u270D Generate Report", font=("Segoe UI", 12, "bold"), bg="#2980b9", fg="white",
